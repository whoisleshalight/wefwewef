(() => {
    ...
    function initSliders() {
        ...
        if (document.querySelector(".portfolio-swiper")) {
            ...
            if (window.innerWidth <= 767.98) isMobileLoppp = true;
        ...
        if (document.querySelector(".expertise-swiper-one")) {
            let onesw = new Swiper(".expertise-swiper-one", {
                modules: [ Navigation, Pagination ],
                observer: true,
                observeParents: true,
                slidesPerView: 4,
            ...
            onesw.on("slideChange", (function() {
                if (window.innerWidth >= 767.98) {
                    if (onesw.activeIndex !== 0) {
                        if (boxSliderOne) if (!boxSliderOne.classList.contains("_swipe-slide")) boxSliderOne.classList.add("_swipe-slide");
                    } else if (boxSliderOne) if (boxSliderOne.classList.contains("_swipe-slide")) boxSliderOne.classList.remove("_swipe-slide");
                } else if (onesw.activeIndex !== 0) {
                    if (boxSliderOne) if (!boxSliderOne.classList.contains("_swipe-slide-mobile")) boxSliderOne.classList.add("_swipe-slide-mobile");
                } else if (boxSliderOne) if (boxSliderOne.classList.contains("_swipe-slide-mobile")) boxSliderOne.classList.remove("_swipe-slide-mobile");
            }));
        }
        if (document.querySelector(".expertise-swiper-two")) {
            let twosw = new Swiper(".expertise-swiper-two", {
                modules: [ Navigation, Pagination ],
                observer: true,
                observeParents: true,
                slidesPerView: 4,
            ...
            twosw.on("slideChange", (function() {
                ...
                } else if (twosw.activeIndex !== 0) {
                    if (boxSliderOne) if (!boxSliderOne.classList.contains("_swipe-slide-mobile")) boxSliderOne.classList.add("_swipe-slide-mobile");
                } else if (boxSliderOne) if (boxSliderOne.classList.contains("_swipe-slide-mobile")) boxSliderOne.classList.remove("_swipe-slide-mobile");
            }));
        }
        if (document.querySelector(".expertise-swiper-three")) {
            let threesw = new Swiper(".expertise-swiper-three", {
                modules: [ Navigation, Pagination ],
                observer: true,
                observeParents: true,
                slidesPerView: 4,
    ...
    if (!document.documentElement.classList.contains("lock")) document.documentElement.classList.add("lock");
    var fileInput = document.querySelector(".input-file"), script_button = document.querySelector(".input-file-trigger"), the_return = document.querySelector(".file-return");
    script_button.addEventListener("keydown", (function(event) {
        if (event.keyCode == 13 || event.keyCode == 32) fileInput.focus();
    }));
    ...
    document.addEventListener("DOMContentLoaded", (event => {
        ...
        document.querySelectorAll(".price-checkbox-item").forEach((checkbox => {
            checkbox.addEventListener("change", (function() {
                if (this.checked) document.querySelectorAll(".price-checkbox-item").forEach((item => {
                    if (item !== this) item.checked = false;
                }));
            }));
        }));
        const modalBtnMenu = document.querySelector(".modal-menu-btn");
        if (modalBtnMenu) modalBtnMenu.addEventListener("click", (function(e) {
